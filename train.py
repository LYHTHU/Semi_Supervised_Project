...
def loss_function(recon_x, x, mu, logvar):
    ...
    BCE = F.binary_cross_entropy(recon_x.view(-1, 3*96*96), x.view(-1, 3*96*96), reduction = 'mean')
...
if __name__ == "__main__":
    ...
    save_path = './conv_encoder_13.pt'
    check_path = 'conv_encoder_13_check'
    model = Conv_Model()
    ...
    optimizer_ft = optim.Adam(model.parameters(), lr=3e-4, betas=(0.5, 0.9))
