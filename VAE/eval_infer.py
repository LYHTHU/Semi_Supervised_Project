...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/scratch/yc3329/ssl_data_96',
    ...
    model = Infer_model(pretrained=True).to(args.device) # DO NOT modify this line - if your Model() takes arguments, they should have default values
